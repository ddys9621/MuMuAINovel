...
- 人物对话：用半文半白的"江湖口吻"，少用现代词汇，多用"在下/兄台/姑娘/前辈"等称呼
...
- 渲染氛围：仙气飘渺的环境描写（云海/仙山/灵兽/法宝），意境优于细节
...
- ⚠️ 雷区：靠巧合推动剧情、关键线索藏到最后才告诉读者（不公平推理）、凶手动机苍白""",
        ...
        "灵异": """【灵异文核心要素】
- 诡异氛围：环境描写营造毛骨悚然感（光线/温度/声音/气味的异常细节）
...
- 婉转表达：用半文半白的对话，"奴婢/妾身/小生/在下"等称谓要正确
...
- **叙述者声调**：可以有叙述者的态度和评论（如"可怜的某某还不知道，命运正在悄悄改变"）
...
5. **叙事与文风要求（重点）**：
   - 必须使用【{narrative_perspective}】视角稳稳讲故事，不要来回切视角（详细规则见上方「叙事视角指导」）
   {perspective_boundary_clause}
   - 类型基调要符合上方「类型特色指导」中的核心爽点和雷区清单
